	...
	private void makeJsonObjReq() {
		...
		JsonObjectRequest jsonObjReq = new JsonObjectRequest(Method.GET, Const.URL_JSON_OBJECT, null, new Response.Listener<JSONObject>() {
					...
					public void onResponse(JSONObject response) {
                        ...
                        try {
//                            Log.e(TAG, "onResponse: name: " + response.getString("name"));

                            JSONObject phoneObject = response.getJSONObject("phone");
//                            Log.e(TAG, "onResponse: mobile: " + phoneObject.getString("mobile"));
					...
					public void onResponse(JSONArray response) {
						...
						for (int i=0;i<response.length();i++) {
                            try {
                                ...
                                Log.e(TAG, "onResponse: name: " + jsonObject.getString("name"));
